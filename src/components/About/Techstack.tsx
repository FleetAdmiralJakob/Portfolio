        ...
        <Container>
            ...
            <Row style={{justifyContent: "center", paddingBottom: "50px"}}>
                <Col xs={4} md={2} className="tech-icons-html">
                    <SiHtml5/>
                    <div className="tech-description">HTML
                        <br/>
                ...
                <Col xs={4} md={2} className="tech-icons-css">
                    <SiCss3/>
                    <div className="tech-description">CSS
                        <br/>
                ...
                <Col xs={4} md={2} className="tech-icons-sass">
                    <DiSass/>
                    <div className="tech-description">Sass
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={10}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons-javascript">
                    <SiJavascript/>
                    <div className="tech-description">JavaScript
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={7}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons-typescript">
                    <SiTypescript/>
                    <div className="tech-description">TypeScript
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={7}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons">
                    <DiJava/>
                    <div className="tech-description">Java
                        <br/>
                ...
                <Col xs={4} md={2} className="tech-icons">
                    <SiKotlin/>
                    <div className="tech-description">Kotlin
                        <br/>
                ...
                <Col xs={4} md={2} className="tech-icons-csharp">
                    <SiCsharp/>
                    <div className="tech-description">C#
                        <br/>
                ...
                <Col xs={4} md={2} className="tech-icons">
                    <SiJson/>
                    <div className="tech-description">JSON
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={10}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons">
                    <SiMarkdown/>
                    <div className="tech-description">Markdown
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={10}/>
                    </div>
                </Col>
            ...
            <Row style={{justifyContent: "center", paddingBottom: "50px"}}>
                <Col xs={4} md={2} className="tech-icons-node">
                    <DiNodejsSmall/>
                    <div className="tech-description">Node.js
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={3}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons-react">
                    <DiReact/>
                    <div className="tech-description">ReactJS
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={10}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons">
                    <SiNextdotjs/>
                    <div className="tech-description">Next.js
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={10}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons-mongo">
                    <SiMongodb/>
                    <div className="tech-description">MongoDB
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={4}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons-wordpress">
                    <DiWordpress/>
                    <div className="tech-description">Wordpress
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={10}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons-git">
                    <DiGit/>
                    <div className="tech-description">Git
                        <br/>
                ...
                <Col xs={4} md={2} className="tech-icons">
                    <DiGithubBadge/>
                    <div className="tech-description">GitHub
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={10}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons-postcss">
                    <SiPostcss/>
                    <div className="tech-description">PostCSS
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={10}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons-tailwind">
                    <SiTailwindcss/>
                    <div className="tech-description">Tailwind
                        <br/>
                        <ConfidenceLevelBar confidenceLevel={10}/>
                    </div>
                </Col>
                <Col xs={4} md={2} className="tech-icons-material">
                    <SiMaterialui/>
                    <div className="tech-description">Material UI
                        <br/>
