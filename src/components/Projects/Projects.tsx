        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <p className="text-project-curseforge">
            ...
            <Col md={12}>
              ...
              <div className="mod-description"><div>A lot of Vanilla Minecraft items are <span className="purple">uncraftable</span> and some of them can only be obtained via grinding or <span className="purple">luck or once</span>. I want to change this, but I'm a big fan of balancing, so these items are still relatively hard to obtain in my opinion, even with this mod. If not make it hard, we may just play in Creative mode, right?</div>
              <span className="read-more" onClick={ changeReadMore }>Read more {!readmore ? <AiOutlineArrowUp/> : <AiOutlineArrowDown/>}</span>
