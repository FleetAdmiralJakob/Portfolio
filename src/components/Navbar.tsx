...
function NavBar() {
    ...
    if (hackerObject) {
        hackerObject.addEventListener("mouseover", () => {
          ...
          interval = setInterval(() => {
            ...
            // @ts-ignore
            if(iterations >= hackerObject.dataset.value.lenght) clearInterval(interval)
  ...
  const hackerObject2 = document.querySelector("#hacker-object2") as HTMLElement;
  ...
  if (hackerObject2) {
    hackerObject2.addEventListener("mouseover", () => {
      ...
      interval2 = setInterval(() => {
        ...
        // @ts-ignore
        if(iterations2 >= hackerObject2.dataset.value.lenght) clearInterval(interval2)
  ...
  const hackerObject3 = document.querySelector("#hacker-object3") as HTMLElement;
  ...
  if (hackerObject3) {
    hackerObject3.addEventListener("mouseover", () => {
      ...
      interval3 = setInterval(() => {
        ...
        // @ts-ignore
        if(iterations3 >= hackerObject3.dataset.value.lenght) clearInterval(interval3)
  ...
  const hackerObject4 = document.querySelector("#hacker-object4") as HTMLElement;
  ...
  if (hackerObject4) {
    hackerObject4.addEventListener("mouseover", () => {
      ...
      interval4 = setInterval(() => {
        ...
        // @ts-ignore
        if(iterations4 >= hackerObject4.dataset.value.lenght) clearInterval(interval4)
  ...
  const hackerObject5 = document.querySelector("#hacker-object5") as HTMLElement;
  ...
  if (hackerObject5) {
    hackerObject5.addEventListener("mouseover", () => {
      ...
      interval5 = setInterval(() => {
        ...
        // @ts-ignore
        if(iterations5 >= hackerObject5.dataset.value.lenght) clearInterval(interval5)
